    ...
    return (
      <div className="glavni">
        ...
        <div className="glavnitext">
          ...
          rezervnih delova za mopede, kosilice, vanbrodske motore , vodene pumpe
          i motorne testere.<br />
          <br /> Akcenat na distribuciji delova za mopede je stavljen na nabavku
          i prodaju delova za tomos mopede. U nasem asortimanu se mogu pronaci
          pored zamenskih i orginalni rezevni delovi brenda tomos.<br />
          ...
          servisiranjem mopeda. Konstantnim razvijanjem i prosirenjem delatnosti
          nasa firma je u mogucnosti da svojim delovanjem pruzi mnogo vise.<br />
